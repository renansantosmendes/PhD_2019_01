...
//    private final int SEED_VALUE = 1;
...
//    private Random RAND_NUMBER = new Random(SEED_VALUE);
     ...
     * <code>betaParameter</code>, <code>q0_Parameter</code>) in which
    ...
    public UFSACO(Object... arguments) {
        ...
        BETA = (double) arguments[6];
        PROB_CHOOSE_EQUATION = (double) arguments[7];
    }
...
//        }
    ...
    public String validate() {
        if (NUM_ANTS > numFeatures || NUM_FEAT_OF_ANT > numFeatures) {
            return "The parameter values of UFSACO (number of ants or number of features for ant) are incorred.";
        }
        return "";
    }
}
