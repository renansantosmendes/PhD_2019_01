 ...
 * @see KFST.featureSelection.filter.unsupervised.IRRFSACO_1
 */
public class IRRFSACO_1Panel extends ParameterPanel {
    ...
    /**
     * Creates new form IRRFSACO_1Panel. This method is called from within the
     * constructor to initialize the form.
     */
    public IRRFSACO_1Panel() {
        super("Parameter Settings Panel",
                "IRRFSACO_1 settings:",
                "<html> Incremental relevance-redundancy feature selection based on ACO, version1 (IRRFSACO_1) is the modified version of the RRFSACO_1 in which a heuristic information measure is used to consider the similarity between subsets of features.  </html>",
                "Option\n\n"
