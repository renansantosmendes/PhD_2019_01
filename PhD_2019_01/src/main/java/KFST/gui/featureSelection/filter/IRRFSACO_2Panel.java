 ...
 * @see KFST.featureSelection.filter.unsupervised.IRRFSACO_2
 */
public class IRRFSACO_2Panel extends ParameterPanel {
    ...
    /**
     * Creates new form IRRFSACO_2Panel. This method is called from within the
     * constructor to initialize the form.
     */
    public IRRFSACO_2Panel() {
        super("Parameter Settings Panel",
                "IRRFSACO_2 settings:",
                "<html>Incremental relevance-redundancy feature selection based on ACO, version2 (IRRFSACO_2) is the modified version of the RRFSACO_2 in which a heuristic information measure is used to consider the similarity between subsets of features.</html>",
                "Option\n\n"
                ...
                new Rectangle(190, 430, 75, 23),
                new Rectangle(310, 430, 75, 23),
                new Dimension(570, 520));
...
//        }
//
//        IRRFSACO_2Panel dtpanel = new IRRFSACO_2Panel();
