 ...
 * @see KFST.featureSelection.filter.unsupervised.UFSACO
 */
public class UFSACOPanel extends ParameterPanel {
    ...
    /**
     * Creates new form UFSACOPanel. This method is called from within the
     * constructor to initialize the form.
     */
    public UFSACOPanel() {
        super("Parameter Settings Panel",
                "UFSACO settings:",
                "<html> Unsupervised feature selection based on ant colony optimization (UFSACO) is a multivariate filter method based on the ant colony optimization. The UFSACO performs an explicit redundancy analysis and implicit relevance analysis. </html> ",
                "Option\n\n"
                ...
                new Rectangle(190, 395, 75, 23),
                new Rectangle(310, 395, 75, 23),
                new Dimension(570, 485));
...
//        this.pack();
     ...
     * @param numbFeatureOfAnt the number of selected features by each ant in
     * each iteration
     ...
     */
    public void setUserValue(double initPheromoneValue, int numIterations, int numberAnt, int numbFeatureOfAnt, double evaporationRate, double betaParameter, double q0_Parameter) {
        initPheromone = initPheromoneValue;
        numIteration = numIterations;
        numAnts = numberAnt;
        numFeatOfAnt = numbFeatureOfAnt;
...
//        }
//
//        UFSACOPanel dtpanel = new UFSACOPanel();
...
//        System.out.println("num feature Of ant = " + dtpanel.getNumFeatOfAnt());
