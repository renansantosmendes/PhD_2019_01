 ...
 * @see KFST.featureSelection.wrapper.PSOBasedMethods.CPSO.CPSO
 */
public class CPSOPanel extends BasicPSOPanel {
    ...
    /**
     * Creates new form CPSOPanel. This method is called from within the
    ...
    public CPSOPanel() {
        ...
        this.setMethodTitle("Continuous PSO method settings:");
        this.setMethodDescription("<html> Feature selection based on continuous particle swarm optimization (CPSO) "
...
//        this.pack();
    ...
    /**
     * sets the last values of the continuous PSO (CPSO) parameters entered by
     * user
     *
