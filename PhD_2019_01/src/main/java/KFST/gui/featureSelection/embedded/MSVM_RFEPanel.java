 ...
 */
package KFST.gui.featureSelection.embedded;
 ...
 * @see KFST.featureSelection.embedded.SVMBasedMethods.MSVM_RFE
 */
public class MSVM_RFEPanel extends ParameterPanel {
    ...
    private double DEFAULT_PARAMETER_C = 1.0;
    private int DEFAULT_NUM_FOLD = 5, DEFAULT_NUM_RUN = 20;
